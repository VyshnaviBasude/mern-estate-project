  ...
  return (
    <div className="p=3 max-w-lg mx-auto">
      ...
      <div className="flex justify-between mt-5">
        <span onClick={handleDelete} className="text-red-300 cursor-pointer">
          {" "}
          Delete Account
        </span>
        <span onClick={handleSignOut} className="text-red-300 cursor-pointer">
          {" "}
          Sign Out{" "}
        </span>
      </div>
      ...
      <p className="text-red-700 mt-5">
        {showListingsError ? "Error Showing Lisitings: " : " "}
      </p>
